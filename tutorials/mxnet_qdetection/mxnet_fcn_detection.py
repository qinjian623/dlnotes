...
def build_network():
    ...
    # 1/8
    dc0, 1_4 = dual_conv_block("dc0", p0, (32, 32))
    # 1/16
    dc1, 1_8 = dual_conv_block("dc1", dc0, (64, 64))
    # 1/32
    dc2, 1_16 = dual_conv_block("dc2", dc1, (128, 128))
    # 1/64
    dc3, 1_32 = dual_conv_block("dc3", dc2, (256, 256))
    ...
    sep = dual_conv_block("xxx", fusion, (16, 16), with_pool=False)
